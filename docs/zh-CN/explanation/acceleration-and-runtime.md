...
- Koharu 支持计算能力 7.0 及以上的 NVIDIA GPU，包括 V100 这类 Volta 显卡
- Koharu 在主 CUDA 管线中内置 CUDA Toolkit 13.0
...
!!! note
    ...
    在 Windows 上，可选的本地 llama.cpp CUDA 运行时仍然使用上游的 CUDA 13.1 包，因此 V100 这类显卡在本地 LLM 推理时会回退到 Vulkan 或 CPU。
